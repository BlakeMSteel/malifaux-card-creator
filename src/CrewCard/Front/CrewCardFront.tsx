...
function TriggerGroupBlock({
  ...
  return (
    <div className="cc-feature-group">
      <p className="cc-preamble">
        {buildTriggerPreamble(
          keyword,
          group.uniqueOnly,
          group.excludePeon,
          group.excludeSummonToken,
          group.actionType,
          group.printedOnStatCard,
        )}
      </p>
  ...
  return (
    <div className="crew-card">
      ...
      <div className="cc-image-area">
        {card.imageUrl && (
          <img src={card.imageUrl} alt="master image" className="cc-image" />
        )}
      </div>
